    ...
    <div className="min-h-screen bg-zinc-50 relative">
      ...
      <div className="min-h-screen grid md:grid-cols-2">
        <div className="hidden md:flex flex-col justify-between bg-zinc-950 p-12 text-white relative overflow-hidden">
          <div className="z-10 mt-20"> {/* Added margin to clear the fixed navbar */}
            <div className="w-10 h-10 bg-white text-zinc-950 rounded-xl flex items-center justify-center font-bold mb-6">M</div>
            <h2 className="text-4xl font-bold max-w-md leading-tight text-white decoration-transparent uppercase">Professional Receipts, Generated Instantly.</h2>
          </div>
        ...
        <div className="flex items-center justify-center p-6 md:p-12 pt-32 md:pt-12"> {/* Adjusted padding for mobile visibility */}
