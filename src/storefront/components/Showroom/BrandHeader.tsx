...
import { 
  ...
  ChevronRight, Home, Grid, Sun, Moon, LayoutDashboard
} from 'lucide-react';
...
import { useAuth } from '@/lib/AuthContext'; // Added Auth Context
...
export default function BrandHeader({ businessName, logoUrl }: BrandHeaderProps) {
  ...
  const { user } = useAuth(); // Fetch user session
  ...
  // 1. ADDED: Handle Customer Login Routing
        ...
        <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-md relative group">
            ...
            <input 
              ...
              defaultValue={searchParams.get('q') || ''} // ADDED
