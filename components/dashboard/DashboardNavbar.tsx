  ...
  return (
    <nav className="bg-white border-b border-zinc-200 sticky top-0 z-50 h-16 flex items-center">
      <div className="max-w-6xl mx-auto px-6 w-full flex items-center justify-between">
        <Link href="/dashboard" className="flex items-center gap-2 font-bold text-zinc-950 text-lg decoration-transparent">
          <div className="w-8 h-8 bg-zinc-950 rounded-lg flex items-center justify-center text-white text-xs uppercase">M</div>
          MifimnPay
        </Link>
        <div className="flex items-center gap-4">
          ...
          <div className="relative group">
            <button className="flex items-center gap-2 p-1 hover:bg-zinc-100 rounded-xl transition-all border border-transparent hover:border-zinc-200">
              ...
              <ChevronDown size={14} className="text-zinc-400 group-hover:text-zinc-950 transition-colors" />
            </button>
            <div className="absolute right-0 mt-2 w-48 bg-white border border-zinc-200 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all py-2 z-50">
